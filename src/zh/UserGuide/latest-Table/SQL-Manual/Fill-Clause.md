...
- 16:40 的 humidity 列，由于辅助列 arrival_time 非 NULL ，为 `1970-01-01T08:00:00.003+08:00`且与前一个非 NULL 值 `1970-01-01T08:00:00.001+08:00`的时间差未超过 2s，因此使用第一行 s1 的值 1 进行填充。
- 16:41 的 humidity 列，尽管 arrival_time 非 NULL，但与前一个非 NULL 值的时间差超过 2s，因此不进行填充。第七行同理。
